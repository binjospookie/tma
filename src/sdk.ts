...
(function () {
    ...
    let isIframe = false, iFrameStyle;
    try {
    ...
    function openProtoUrl(url) {
      ...
      const useIframe = navigator.userAgent.match(/iOS|iPhone OS|iPhone|iPod|iPad/i) ? true : false;
      if (useIframe) {
  ...
  (function () {
    ...
    const WebApp = {};
    let webAppInitData = '', webAppInitDataUnsafe = {};
    let themeParams = {}, colorScheme = 'light';
    ...
    function generateCallbackId(len) {
      let tries = 100;
      while (--tries) {
        let id = '', chars = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789', chars_len = chars.length;
        for (let i = 0; i < len; i++) {
    ...
    let viewportHeight = false, viewportStableHeight = false, isExpanded = true;
    ...
    const safeAreaInset = {top: 0, bottom: 0, left: 0, right: 0};
    ...
    const contentSafeAreaInset = {top: 0, bottom: 0, left: 0, right: 0};
    ...
    function setHeaderColor(color) {
      ...
      let head_color = null, color_key = null;
    ...
    let appHeaderColorKey = null, appHeaderColor = null;
    ...
    const BottomButtonConstructor = function(type) {
      ...
      function buttonParams() {
        const color = bottomButton.color;
    ...
    const BiometricManager = (function() {
      ...
      const initRequestState = {callbacks: []};
    ...
    const LocationManager = (function() {
      ...
      const initRequestState = {callbacks: []};
      const getRequestState = {callbacks: []};
    ...
    const Accelerometer = (function() {
      let isStarted = false;
      let valueX = null, valueY = null, valueZ = null;
      let startCallbacks = [], stopCallbacks = [];
    ...
    const DeviceOrientation = (function() {
      let isStarted = false;
      let valueAlpha = null, valueBeta = null, valueGamma = null, valueAbsolute = false;
      let startCallbacks = [], stopCallbacks = [];
    ...
    function getRequestedContact(callback, timeout) {
      let reqTo, fallbackTo, reqDelay = 0;
      const reqInvoke = function() {
    ...
    function invokeCustomMethod(method, params, callback) {
      ...
      const req_params = {req_id: req_id, method: method, params: params || {}};
    ...
    WebApp.switchInlineQuery = function (query, choose_chat_types) {
      ...
      if (choose_chat_types) {
        ...
        const good_types = {users: 1, bots: 1, groups: 1, channels: 1};
    ...
    WebApp.openTelegramLink = function (url, options) {
      ...
      if (isIframe || versionAtLeast('6.1')) {
        const req_params = {path_full: path_full};
    ...
    WebApp.openInvoice = function (url, callback) {
      let a = document.createElement('A'), match, slug;
      a.href = url;
      if (a.protocol != 'http:' &&
          a.protocol != 'https:' ||
          a.hostname != 't.me' ||
    ...
    WebApp.readTextFromClipboard = function (callback) {
      ...
      const req_id = generateCallbackId(16);
      const req_params = {req_id: req_id};
      webAppCallbacks[req_id] = {
        callback: callback
      };
